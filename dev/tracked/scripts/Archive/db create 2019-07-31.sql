...
(
    ...
    is_active                 TINYINT(1)                  NOT NULL COMMENT 'is record active',
    UNIQUE INDEX UNIQ_C8B28E44E7927C74 (email),
...
(
    ...
    number_of_properties      INT UNSIGNED DEFAULT NULL COMMENT 'number of properties in this assocaition',
    is_management_company     TINYINT(1)                  NOT NULL COMMENT 'Is current Record representing a Management Company',
    is_association_company    TINYINT(1)                  NOT NULL COMMENT 'Is current Record representing an HOA',
    created_from_ip           VARCHAR(45)  DEFAULT NULL,
    updated_from_ip           VARCHAR(45)  DEFAULT NULL,
    created_at                DATETIME                    NOT NULL,
    updated_at                DATETIME                    NOT NULL,
...
(
    ...
    description           VARCHAR(128)                NOT NULL COMMENT 'Description of Permission',
    html_description_long TEXT     DEFAULT NULL COMMENT 'An HTML based long description of Permission',
    permission_group      LONGTEXT DEFAULT NULL COMMENT '(DC2Type:array)',
    INDEX idx_permission_description (description),
...
(
    ...
    name_last                    VARCHAR(32)                 NOT NULL COMMENT 'last name',
    name_suffix                  VARCHAR(12)  DEFAULT NULL COMMENT 'suffix',
    name_trustee                 VARCHAR(180) DEFAULT NULL COMMENT 'Legal Name for Person (ie, Trustee Name).',
    mailing_address_line1        CHAR(128)                   NOT NULL COMMENT 'mailing address line 1',
    mailing_address_line2        CHAR(128)    DEFAULT NULL COMMENT 'mailing address line 1',
    mailing_address_city         CHAR(128)                   NOT NULL COMMENT 'mailing address city',
    mailing_address_state        CHAR(2)                     NOT NULL COMMENT 'mailing address state',
...
(
    ...
    date_end                  DATETIME                    NOT NULL COMMENT 'date when this owner lost posession.',
    physical_address_line1    CHAR(128)                   NOT NULL COMMENT 'physical address line 1',
    physical_address_line2    CHAR(128)    DEFAULT NULL COMMENT 'physical address line 1',
    physical_address_city     CHAR(128)                   NOT NULL COMMENT 'physical address city',
...
(
    ...
    candidate_id    INT UNSIGNED DEFAULT NULL COMMENT 'primary key for candidate',
    created_from_ip VARCHAR(45)  DEFAULT NULL,
    updated_from_ip VARCHAR(45)  DEFAULT NULL,
    created_at      DATETIME                    NOT NULL,
    updated_at      DATETIME                    NOT NULL,
...
ALTER TABLE ballot
    ADD CONSTRAINT FK_D59CE9BD417E6B4D FOREIGN KEY (ballot_type_id) REFERENCES ballot_type (ballot_type_id) ON DELETE SET NULL;
ALTER TABLE ballot
    ADD CONSTRAINT FK_D59CE9BDEBB4B8AD FOREIGN KEY (voter_id) REFERENCES voter (voter_id) ON DELETE SET NULL;
ALTER TABLE candidate
    ADD CONSTRAINT FK_C8B28E44A708DAFF FOREIGN KEY (election_id) REFERENCES election (election_id) ON DELETE SET NULL;
ALTER TABLE company
    ADD CONSTRAINT FK_4FBF094F217BBB47 FOREIGN KEY (person_id) REFERENCES person (id) ON DELETE SET NULL;
ALTER TABLE election
    ADD CONSTRAINT FK_DCA03800EFB9C8A5 FOREIGN KEY (association_id) REFERENCES association (association_id) ON DELETE SET NULL;
ALTER TABLE election
    ADD CONSTRAINT FK_DCA038007F91056D FOREIGN KEY (election_type_id) REFERENCES election_type (election_type_id) ON DELETE SET NULL;
...
ALTER TABLE property
    ADD CONSTRAINT FK_8BF21CDE7E3C61F9 FOREIGN KEY (owner_id) REFERENCES person (id) ON DELETE SET NULL;
ALTER TABLE vote
    ADD CONSTRAINT FK_5A108564DDC23F6C FOREIGN KEY (ballot_id) REFERENCES ballot (ballot_id) ON DELETE SET NULL;
ALTER TABLE vote
    ADD CONSTRAINT FK_5A10856491BD8781 FOREIGN KEY (candidate_id) REFERENCES candidate (candidate_id) ON DELETE SET NULL;
ALTER TABLE voter
    ADD CONSTRAINT FK_268C4A59A708DAFF FOREIGN KEY (election_id) REFERENCES election (election_id) ON DELETE SET NULL;
ALTER TABLE voter
    ADD CONSTRAINT FK_268C4A59549213EC FOREIGN KEY (property_id) REFERENCES property (property_id) ON DELETE SET NULL;
ALTER TABLE voter
    ADD CONSTRAINT FK_268C4A59DB494898 FOREIGN KEY (proxy_person_id) REFERENCES person (id) ON DELETE SET NULL;
